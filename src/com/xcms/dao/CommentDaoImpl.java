...
public class CommentDaoImpl implements CommentDao{
	...
	public ArrayList<Comment> getAllComment() {
		//System.out.println("是否进入getAllComment方法？");
	...
	public ArrayList<Comment> getPageComment(int page, int limit) {
		//System.out.println("是否进入getPageComment方法");
		...
		ArrayList<Comment> cList = null;                                                                                                   
		Connection conn = DBUtil.getConnection();
		String sql =  "select * from comment limit "+startRow+","+limit+"";
		try {
			PreparedStatement prep = null;
			if (conn != null) {
				prep = conn.prepareStatement(sql);
	...
	public boolean delComment(int comment_id) {
		//System.out.println("是否进入delComemnt方法");
		Connection conn = DBUtil.getConnection();
	...
	public boolean insertComment(Comment c) {
		Connection conn = DBUtil.getConnection();
		//在数据库中添加记录
		String sql = "insert into comment(comment_name,parent_id,comment_content,comment_likenum,comment_createtime,comment_type,comment_email) values(?,?,?,?,?,?,?)";
		// 预编译
		PreparedStatement prep=null;
		try {
			if (conn != null) {
	...
	public ArrayList<Comment> getPageTypeComment(int comment_type,int page,int limit) {
		...
		ArrayList<Comment> cList = null;                                                                                                   
		Connection conn = DBUtil.getConnection();
		String sql =  "select * from comment where comment_type = ? order by comment_createtime desc limit "+startRow+","+limit+"";
		try {
	...
	public ArrayList<Comment> getPageContentComment(String comment_content,int page,int limit) {
		...
		ArrayList<Comment> cList = null;                                                                                                   
		Connection conn = DBUtil.getConnection();
		String sql =  "select * from comment where comment_content like '%"+comment_content+"%' limit "+startRow+","+limit+"";
		try {
			PreparedStatement prep = conn.prepareStatement(sql);
			ResultSet rst = prep.executeQuery();
			cList = new ArrayList<Comment>(); 
	...
	public ArrayList<Comment> getPageSpecificComment(int comment_type, String comment_content,int page,int limit) {
		...
		ArrayList<Comment> cList = null;                                                                                                   
		Connection conn = DBUtil.getConnection();
		String sql =  "select * from comment where comment_type = ? and comment_content like '%"+comment_content+"%' limit "+startRow+","+limit+"";
		try {
			PreparedStatement prep = conn.prepareStatement(sql);
			prep.setInt(1, comment_type);
			ResultSet rst = prep.executeQuery();
	...
	public ArrayList<Comment> getTypeComment(int comment_type) {
		...
		ArrayList<Comment> cList = null;                                                                                                   
		Connection conn = DBUtil.getConnection();
		String sql =  "select * from comment where comment_type = ?";
		try {
			PreparedStatement prep = conn.prepareStatement(sql);
			prep.setInt(1,comment_type);
			ResultSet rst = prep.executeQuery();
	...
	public ArrayList<Comment> getSpecificComment(int comment_type, String comment_content) {
		...
		ArrayList<Comment> cList = null;                                                                                                   
		Connection conn = DBUtil.getConnection();
		String sql =  "select * from comment where comment_type = ? and comment_content like '%"+comment_content+"%' ";
		try {
			PreparedStatement prep = conn.prepareStatement(sql);
			prep.setInt(1, comment_type);
			ResultSet rst = prep.executeQuery();
