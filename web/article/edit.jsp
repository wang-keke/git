...
//	int article_id = (int)request.getAttribute("article_id");
	int article_id = Integer.parseInt ((request.getAttribute("article_id")).toString());
...
//	int article_isTop = (int)request.getAttribute("article_isTop");
	int article_isTop = Integer.parseInt ((request.getAttribute("article_isTop")).toString());
...
//	int tag3 = (int)request.getAttribute("tag3");
	int tag1 = Integer.parseInt ((request.getAttribute("tag1")).toString());
	int tag2 = Integer.parseInt ((request.getAttribute("tag2")).toString());
	int tag3 = Integer.parseInt ((request.getAttribute("tag3")).toString());
			...
			,
				...
				if (res.code == 0) {
					...
					$("#article_image")
							.attr(
									"src",
									"http://localhost:8080/web_work/upload/"
											+ returnPath);
