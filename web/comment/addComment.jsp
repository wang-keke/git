		...
		<form class="layui-form" action="">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<select name="type" lay-verify="" id="pid">
						<option value="1" id="type1">给我留言</option>
						<option value="2" id="type2">文章归档</option>
						<option value="3" id="type3">业务合作</option>
						<option value="4" id="type4">关于我</option>
